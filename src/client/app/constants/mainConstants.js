const mainConstants = {
  hostNumbers: [
    ...
    {value: 20, label: 'entre 10 e 20'},{value: 50, label: 'entre 20 e 50'},
    {value: 100, label: 'entre 50 e 100'},{value: 150, label: 'entre 100 e 150'},
    {value: 250, label: 'entre 250 e 300'},{value: 300, label: 'mais de 300'},
  ],
  hostOptions: [
