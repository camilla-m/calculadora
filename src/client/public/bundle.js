...
var MailForm = function (_React$Component) {
  ...
  function MailForm(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MailForm.__proto__ || Object.getPrototypeOf(MailForm)).call(this, props));

    _this.state = { emailValue: '' };

    _this.handleInputChage = _this.handleInputChage.bind(_this);
    _this.handleForm = _this.handleForm.bind(_this);
    return _this;
  }

  _createClass(MailForm, [{
    key: 'handleInputChage',
    value: function handleInputChage(e) {
    ...
    value: function handleForm() {
      var finalUrl = 'https://app.umbler.com/account/register/?email=' + this.state.emailValue;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { 'class': 'icon icon-email-read' }),
...
var _mainConstants = __webpack_require__(20);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      ...
      hostSelectedOption: _mainConstants2.default.hostOptions[0],
    ...
    _this.handleHostNumberChange = _this.handleHostNumberChange.bind(_this);
    _this.handlePurposeChange = _this.handlePurposeChange.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'handleHostTypeChange',
    value: function handleHostTypeChange(hostSelectedOption) {
      this.setState({ hostSelectedOption: hostSelectedOption });
    }
  }, {
    key: 'handlePurposeChange',
    value: function handlePurposeChange(purposeSelectedOption) {
      this.setState({ purposeSelectedOption: purposeSelectedOption });
    }
  }, {
    key: 'handleHostNumberChange',
    ...
    value: function render() {
      var _state = this.state,
          hostOptions = _state.hostOptions,
          hostSelectedOption = _state.hostSelectedOption,
          purposeSelectedOption = _state.purposeSelectedOption,
          hostNumber = _state.hostNumber;
...
var FirstInput = function (_React$Component) {
  _inherits(FirstInput, _React$Component);

  function FirstInput() {
    _classCallCheck(this, FirstInput);

    return _possibleConstructorReturn(this, (FirstInput.__proto__ || Object.getPrototypeOf(FirstInput)).apply(this, arguments));
  }

  _createClass(FirstInput, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          hostSelectedOption = _props.hostSelectedOption,
          purposeSelectedOption = _props.purposeSelectedOption,
          hostNumber = _props.hostNumber,
          hostOptions = _props.hostOptions;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          { 'class': 'display-sm-4 mb-3' },
          _react2.default.createElement(
            'span',
            { 'class': 'text-wordpress' },
            'QuantoCusta'
          ),
          ' Hospedar?me'
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            { 'class': 'h5' },
            'Na Umbler voc\xEA tem facilidade, seguran\xE7a e estabilidade. ',
            _react2.default.createElement('br', null),
            ' Agora poder\xE1 descobrir quanto ir\xE1 economizar e qual o plano ',
            _react2.default.createElement('br', null),
            ' indicado para sua necessidade!'
          )
        ),
        _react2.default.createElement(
          'span',
...
var SiteDetails = function (_React$Component) {
  _inherits(SiteDetails, _React$Component);
  ...
  function SiteDetails(props) {
    ...
    _this.handleProgrammingLanguageChange = _this.handleProgrammingLanguageChange.bind(_this);
    _this.handlePlatformChange = _this.handlePlatformChange.bind(_this);
    _this.handleEnvironmentChange = _this.handleEnvironmentChange.bind(_this);
    _this.handleDatabaseNumberChange = _this.handleDatabaseNumberChange.bind(_this);
    _this.handleDatabaseChange = _this.handleDatabaseChange.bind(_this);
    _this.handlePeriodChange = _this.handlePeriodChange.bind(_this);
    _this.handleComplementChange = _this.handleComplementChange.bind(_this);
    _this.handleVisitsChange = _this.handleVisitsChange.bind(_this);
    return _this;
  }

  _createClass(SiteDetails, [{
    key: 'handleProgrammingLanguageChange',
    value: function handleProgrammingLanguageChange(programmingLanguage) {
    ...
    value: function handleEnvironmentChange(environment) {
      this.setState({ environment: environment });
    }
  }, {
    key: 'handleDatabaseNumberChange',
    value: function handleDatabaseNumberChange(e) {
      var value = parseInt(e.target.value);
      this.setState({ databaseNumber: value });
    }
  }, {
    key: 'handleDatabaseChange',
    value: function handleDatabaseChange(database) {
    ...
    key: 'handleComplementChange',
    value: function handleComplementChange(complement) {
      this.setState({ complement: complement });
    }
  }, {
    ...
    value: function render() {
      ...
      var _state = this.state,
          programmingLanguage = _state.programmingLanguage,
          platform = _state.platform,
          environment = _state.environment,
          databaseNumber = _state.databaseNumber,
          database = _state.database,
          period = _state.period,
          complement = _state.complement,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          databaseNumber < 2 ? _react2.default.createElement(
            'span',
            { className: 'input-text' },
            'banco de dados'
          ) : _react2.default.createElement(
        ...
        _react2.default.createElement(_SiteResults2.default, _extends({}, this.state, this.props))
      );
    }
  }]);
...
var _MailForm = __webpack_require__(21);
...
function calcVisits(period, visits, complement, hostNumber) {
  var result = complement === 'each' ? period * visits * hostNumber : period * visits / hostNumber;
  return result;
}
...
var SiteResults = function (_React$Component) {
  _inherits(SiteResults, _React$Component);

  function SiteResults() {
    _classCallCheck(this, SiteResults);

    return _possibleConstructorReturn(this, (SiteResults.__proto__ || Object.getPrototypeOf(SiteResults)).apply(this, arguments));
  }

  _createClass(SiteResults, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          hostSelectedOption = _props.hostSelectedOption,
          ...
          databaseNumber = _props.databaseNumber,
...
var AppDetails = function (_React$Component) {
  _inherits(AppDetails, _React$Component);

  function AppDetails() {
    _classCallCheck(this, AppDetails);

    return _possibleConstructorReturn(this, (AppDetails.__proto__ || Object.getPrototypeOf(AppDetails)).apply(this, arguments));
  }
  ...
  _createClass(AppDetails, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        'Programado em Node.JS, Outra linguagem. Preciso de 1, 2, 3 ... 20 inst\xE2ncia(s)/cont\xE2iner(s) Com 0 (op\xE7\xE3o default), 1, 2, 3, 4, 5, mais de 5 bancos de dados MongoDB, MySQL, SQL Server'
      );
    }
  }]);
